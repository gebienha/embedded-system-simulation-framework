...
- More peripherals added, including: **7-segments display**, **LEDs**

## Built With

- [JsSpim](https://github.com/ShawnZhong/JsSpim) - The initial framework we used to make this simulator.
